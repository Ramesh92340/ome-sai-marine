    ...
    <li class="nav-item">
        ...
        <div id="collapseMedia" class="collapse" aria-labelledby="headingMedia" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="upload_media.php"> <i class="fas fa-fw fa-upload"></i> Upload Media</a>
                <a class="collapse-item" href="all_media.php"> <i class="fas fa-fw fa-th"></i> View/Edit Gallery</a>
            </div>
        </div>
    </li>
