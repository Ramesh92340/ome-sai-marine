...
<main id="main">
    ...
    <section class="services-header-section py-5">
        <div class="container" data-aos="fade-up">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-4 d-none d-md-block text-md-end pe-md-5">
                ...
                <div class="col-md-8">
                    <h2 class="services-main-title">Our <br>Marine Services</h2>
                    <p class="services-main-desc">
                        At Ome Sai Marine, we provide a comprehensive range of marine services designed to
    ...
    <section class="services-list-section pb-5">
        <div class="container">
            ...
            <div class="row align-items-center flex-row-reverse service-row" data-aos="fade-left">
                <div class="col-lg-7">
                    <img src="assets/img/marine/tankers.png" class="img-fluid service-img" alt="Pontoon">
                </div>
                <div class="col-lg-5">
                    <div class="service-text-card card-left">
