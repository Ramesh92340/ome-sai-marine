...
<head>
  ...
  <link href="assets/img/marine/logo.png" rel=" icon">
...
<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="navbar_bg">
    <div class="container d-flex align-items-center">

      <div class="logo-text-container d-flex flex-row justify-content-center align-items-center">
        <a href="index.php" class=" ">
          <img src="assets/img/marine/logo.png" class=" nav_logo " alt="">
        </a>
